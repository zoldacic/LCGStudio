...
public class DragAndDropItemBase : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    static public DragAndDropItemBase draggedItem;                                      // Item that is dragged now
    static public GameObject icon;                                                  // Icon of dragged item
    static public DragAndDropCellBase sourceCell;                                       // From this cell dragged item is

    public delegate void DragEvent(DragAndDropItemBase item);
    ...
    {
        sourceCell = GetComponentInParent<DragAndDropCellBase>();                       // Remember source cell
